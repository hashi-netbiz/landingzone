...
resource "azurerm_firewall_policy_rule_collection_group" "policy" {
  name               = "tcw-${var.environment}-aksegresspolicyrulecollectiongroup"
  firewall_policy_id = azurerm_firewall_policy.policy.id
  priority           = 500
...
resource "azurerm_monitor_diagnostic_setting" "settings" {
  name                       = "tcw-${var.environment}-main-fw-ds"
...
resource "azurerm_monitor_diagnostic_setting" "pip_settings" {
  name                       = "tcw-${var.environment}-main-pipfw-ds"
